...
var privateRoutes = [
	...
	"books.insert",
	"books.details",
	"books.details.issues",
	"books.details.insert",
	"books.details.edit",
	"books.edit",
	"user_settings",
...
Router.map(function () {
	...
	this.route("books", {path: "/books", controller: "BooksController"});
	this.route("books.insert", {path: "/books/insert", controller: "BooksInsertController"});
	this.route("books.details", {path: "/books/details/:bookId", controller: "BooksDetailsController"});
	this.route("books.details.issues", {path: "/books/details/:bookId/issues", controller: "BooksDetailsIssuesController"});
	this.route("books.details.insert", {path: "/books/details/:bookId/insert", controller: "BooksDetailsInsertController"});
	this.route("books.details.edit", {path: "/books/details/:bookId/edit/:issueId", controller: "BooksDetailsEditController"});
	this.route("books.edit", {path: "/books/edit/:bookId", controller: "BooksEditController"});
